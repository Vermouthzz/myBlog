...
export default function CreateResumePage() {
  ...
  <div className="flex py-[40px] common-border-btm">
      ...
      <form className="flex-1">
          <div className="mb-[20px] flex flex-col">
              <label htmlFor="school" className="text-[14px] mb-[10px] require">姓名</label>
              <input type="text" placeholder="hhhhh哈哈哈哈哈" id="school" className="common-input" />
          </div>
          <div className="mb-[20px] flex flex-col">
              <label htmlFor="school" className="text-[14px] mb-[10px] require">手机号码</label>
              <input type="text" placeholder="hhhhh哈哈哈哈哈" id="school" className="common-input" />
          </div>
          <div className="mb-[20px] flex flex-col">
              <label htmlFor="school" className="text-[14px] mb-[10px] require">邮箱</label>
              <input type="text" placeholder="hhhhh哈哈哈哈哈" id="school" className="common-input" />
          </div>
      </form>
  </div>
  <div className="py-[40px] common-border-btm">
      <div className="flex pb-[40px]">
          ...
          <label htmlFor="" className="ml-[15px]">没有工作经历</label>
      </div>
      <div className="flex">
          ...
          <div className="px-[20px] common-hover flex-1">
              <form className="pt-[25px] border-t border-[#EFF1F1]">
                  <div className="mb-[20px] flex flex-col">
                      <label htmlFor="school" className="text-[14px] mb-[10px] require">公司</label>
                      <input type="text" placeholder="hhhhh哈哈哈哈哈" id="school" className="common-input" />
                  </div>
                  <div className="mb-[20px] flex flex-col">
                      <label htmlFor="school" className="text-[14px] mb-[10px] require">职位</label>
                      <input type="text" placeholder="hhhhh哈哈哈哈哈" id="school" className="common-input" />
                  </div>
                  <div className="mb-[20px] flex flex-col">
                      <label htmlFor="school" className="text-[14px] mb-[10px] require">起止时间</label>
                      <div className="flex">
                          <div className="date-select flex-1 h-[36px]" style={{borderRadius: '5px 0 0 5px;'}}></div>
                          <div className="date-select flex-1 h-[36px]" style={{borderRadius: '0 5px 5px 0;'}}></div>
                      </div>
                  </div>
  ...
  <div className="flex py-[40px] commoon-block">
      ...
      <form className="flex-1 common-hover p-[20px]">
          <div className="mb-[20px] flex flex-col">
              <label htmlFor="school" className="text-[14px] mb-[10px] require">学校</label>
              <input type="text" placeholder="hhhhh哈哈哈哈哈" id="school" className="common-input" />
          </div>
          <div className="mb-[20px] flex flex-col">
              <label htmlFor="school" className="text-[14px] mb-[10px] require">学历</label>
              <input type="text" placeholder="hhhhh哈哈哈哈哈" id="school" className="common-input" />
          </div>
          <div className="mb-[20px] flex flex-col">
              <label htmlFor="school" className="text-[14px] mb-[10px] require">专业</label>
              <input type="text" placeholder="hhhhh哈哈哈哈哈" id="school" className="common-input" />
          </div>
          <div className="flex flex-col">
              <label htmlFor="school" className="text-[14px] mb-[10px] require">起止时间</label>
              <div className="flex">
                  <div className="date-select flex-1 h-[36px] relative" style={{borderRadius: '5px 0 0 5px;'}}>
                      <div>
                          {/* 年 */}
                          <ul>
                              <li></li>
  ...
  <div className="flex py-[40px] commoon-block">
      ...
      <div className="p-[10px] flex-1">
          <div className="relative">
              <label htmlFor="school" className="text-[14px]">语言</label>
              ...
              <ul className="absolute w-full p-[10px] shadow-xl bg-white h-[0px] hidden overflow-scroll ul-list"
                  ref="langueRef">
                  <li className="p-[10px] li-item" v-htmlFor="item in langueList" :key="item.text">{{ item.text }}</li>
              </ul>
          </div>
          <div className="relative">
